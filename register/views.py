...
from .views1 import ActivationView as BaseActivationView
from .views1 import RegistrationView as BaseRegistrationView
from .views1 import ResendActivationView as BaseResendActivationView
...
class RegistrationView(BaseRegistrationView):
    ...
    * The creation of the templates
    ...
    success_url = reverse_lazy('register:registration_complete')
...
class ActivationView(BaseActivationView):
    ...
    def get_success_url(self, user):
        return ('register:registration_activation_complete', (), {})
